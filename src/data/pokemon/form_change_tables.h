...
static const struct FormChange sDeoxysNormalFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_TURN_START, SPECIES_DEOXYS_ATTACK,  ITEM_METEORITE, 1, ABILITY_FORM_CHANGE},
    {FORM_CHANGE_BATTLE_TURN_START, SPECIES_DEOXYS_DEFENSE, ITEM_METEORITE, 2, ABILITY_FORM_CHANGE},
    {FORM_CHANGE_BATTLE_TURN_START, SPECIES_DEOXYS_SPEED,   ITEM_METEORITE, 3, ABILITY_FORM_CHANGE},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sDeoxysAttackFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE,          SPECIES_DEOXYS_DEFENSE, ITEM_METEORITE},
    {FORM_CHANGE_BATTLE_TURN_START, SPECIES_DEOXYS_NORMAL,  ITEM_METEORITE, 0, ABILITY_FORM_CHANGE},
    {FORM_CHANGE_BATTLE_TURN_START, SPECIES_DEOXYS_DEFENSE, ITEM_METEORITE, 2, ABILITY_FORM_CHANGE},
    {FORM_CHANGE_BATTLE_TURN_START, SPECIES_DEOXYS_SPEED,   ITEM_METEORITE, 3, ABILITY_FORM_CHANGE},
    {FORM_CHANGE_TERMINATOR},
};
